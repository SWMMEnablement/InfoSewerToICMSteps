          ...
          <Alert type="info">
            ...
            <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-blue-500">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                <p><strong>1. Convert DBF Files to CSV:</strong> Use Excel VBA macro to convert all DBF files in the InfoSewer IEDB folder to CSV format for importing network data into ICM.</p>
